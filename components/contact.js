...
export default function contact() {
  ...
  return (
    <section className="py-1 h-100 whitespace-normal mt-20" id="contact">

      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        <h2 className="text-1xl md:text-4xl font-bold font-sans md:font-sans mb-5 text-center">Contact Us</h2>
        ...
        <form method="post" action="#" className="space-y-8" onSubmit={handleOnSubmit}>
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-orange-400 sm:w-fit hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
        </form>
      </div>
    </section>
  )
